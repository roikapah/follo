...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './persons.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONS actions', async () => {
      const expectedActions = [
        {
