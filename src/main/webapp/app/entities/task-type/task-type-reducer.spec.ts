...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './task-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKTYPE actions', async () => {
      const expectedActions = [
        {
