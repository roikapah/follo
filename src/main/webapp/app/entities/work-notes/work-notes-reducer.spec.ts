...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKNOTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKNOTES actions', async () => {
      const expectedActions = [
        {
